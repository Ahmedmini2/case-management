...
import { CaseWhatsAppPanel } from "@/components/whatsapp/CaseWhatsAppPanel";

function WhatsAppTabIcon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
